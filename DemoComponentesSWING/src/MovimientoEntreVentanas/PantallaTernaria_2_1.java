 ...
 */
public class PantallaTernaria_2_1 extends javax.swing.JDialog {

    //Paquete PantallaTernaria_2_1
    public PantallaTernaria_2_1(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaTernaria_2_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PantallaTernaria_2_1 dialog = new PantallaTernaria_2_1(new javax.swing.JDialog(), true);
